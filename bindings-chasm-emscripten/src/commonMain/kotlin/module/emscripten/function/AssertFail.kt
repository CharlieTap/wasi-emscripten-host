...
internal class AssertFail(
    ...
    override val function: HostFunction = HostFunction { parameters, _ ->
        val condition = parameters.readI32(0)
        val filename = parameters.readI32(1)
        val line = parameters.readI32(2)
        val func = parameters.readI32(3)
        withMemory(memoryIndex) {
            handle.execute(this, condition, filename, line, func, ChasmMemoryAccess)
        }
    }
}
